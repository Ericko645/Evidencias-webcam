...
Public Class WebcamForm
    ...
    Dim DIRECTORIO As String = "C:\Users\Lenovo L570\Desktop\Evidencia fotografica\" ' AQUI COLOCA LA RUTA A TU ESCRITORIO
    ...
    Public Sub OpenPreviewWindow()
        ...
        '
        hHwnd = capCreateCaptureWindowA(iDevice, WS_VISIBLE Or WS_CHILD, 0, 0, 720,
        1024, VISOR.Handle.ToInt32, 0)
    ...
    Public Sub OpenPreviewWindowCliente()
        ...
        '
        hHwnd = capCreateCaptureWindowA(iDevice, WS_VISIBLE Or WS_CHILD, 0, 0, 720,
           1060, MainForm.PicFoto.Handle.ToInt32, 0)
    ...
    Private Sub FSERIE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FSERIE.Click
        Reloj.Enabled = False
    ...
    Private Sub FGRABAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FGRABAR.Click
    ...
    Private Sub CamaraForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub

    Private Sub VISOR_Click(sender As Object, e As EventArgs) Handles VISOR.Click
